...
print('Length of vacab: %s' % vocab_size)
...
############################################
# Weights connecing the inputs to the hidden layer
############################################
...
def sample(prefix, num_chars, temperature=1.0):
    ...
    ############################################
    # Prepare the prefix as a swquence of one-hots for ingestion by RNN
    ############################################
